import { Chart, Filler, CategoryScale, LinearScale, PointElement, LineElement, CoreChartOptions, Legend} from 'chart.js';
import ChartDataLabels, {Context} from 'chartjs-plugin-datalabels'
import { Line } from 'react-chartjs-2';
import './areaChart.css'


Chart.register(Filler, CategoryScale, LinearScale, PointElement, LineElement, Legend, ChartDataLabels);

const labels = ['0', '500Hz', '1000Hz', '2000Hz','4000Hz','8000Hz', '8500Hz'];
